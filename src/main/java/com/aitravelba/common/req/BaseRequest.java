package com.aitravelba.common.req;
...
public class BaseRequest implements Serializable {
    ...
    public static class TerminalInfo implements Serializable {
        ...
        @Override
        public String toString() {
            return "TerminalInfo [imei=" + imei + ", appversion=" + appversion + ", channel="
                    + channel + ", platform=" + platform + ", model=" + model + ", os=" + os
                    + ", networkType=" + networkType + ", bb=" + bb + ", hostIp=" + hostIp
